    ...
    Model2DBuilder::new()
        ...
        .with_primitive(
            Primitive2DBuilder::new()
                ...
                .with_vertex(Vertex2D::new(
                    bmp_24b_x_zero + bmp_24b_width,
                    bmp_24b_y_zero + bmp_24b_height,
                ))
                .build(),
        )
        .build()
...
pub(super) fn create_2d_tga_32b_b2t_l2r() -> Model2D {
    ...
    let tga_y_zero = 50.0;
    let tga = Targa::load_from_bytes(TGA_32B_B2T_L2R)
        .expect("failed to load ../assets/tga/32b_b2t_l2r_footer.tga");
    ...
    Model2DBuilder::new()
        ...
        .with_primitive(
            Primitive2DBuilder::new()
                ...
                .with_vertex(Vertex2D::new(
                    tga_x_zero + tga_width,
                    tga_y_zero + tga_height,
                ))
                .build(),
        )
        .build()
