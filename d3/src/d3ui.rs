    ...
    ViewBuilder::new()
        ...
        .with_panel(PanelBuilder::new()
            ...
            .with_panel(PanelBuilder::new()
                ...
                .with_widget(WidgetBuilder::new()
                                 .with_text("exit game")
                                 .with_click_action(Box::new(|_,_,_,_,_,| log(LogLevel::Info, &|| String::from("clicked exit button"))))
                                 .build(), Sizing::Percentage { percent: 0.2 })
                            .with_panel(PanelBuilder::new()
                                            .with_layout(Layout::Horizontal)
                                            .build()
                ...
                .with_widget(WidgetBuilder::new()
                                 ...
                                 .with_click_action(Box::new(|_,_,_,_,_,| log(LogLevel::Info, &|| String::from("clicked return button"))))
                                 .build(), Sizing::Percentage { percent: 0.2 })
                .with_panel(PanelBuilder::new()
                                .with_layout(Layout::Horizontal)
                                .build()
